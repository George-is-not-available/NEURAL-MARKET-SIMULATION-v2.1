...
async function initializeMoonshotAIOnly() {
  try {
    console.log('🚀 Initializing Moonshot AI Manager without MongoDB...');
    ...
    if (moonshotAIManager) {
      ...
      setTimeout(() => {
        if (moonshotAIManager) {
          ...
          console.log('💭 Started Moonshot AI thought generation');
        }
      }, 5000);
    }
    
    console.log('🎆 Moonshot AI Manager initialized successfully!');
  } catch (error) {
    console.error('❌ Error initializing Moonshot AI Manager:', error);
  }
}
